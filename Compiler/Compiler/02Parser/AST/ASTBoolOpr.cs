        ...
        public override int GenerateCode(int loc, IVirtualMachine vm, CheckerInformation info)
        {
            ...
            switch (Operator)
            {
                ...
                case Operators.CAND:
                    ...
                    vm.UncondJump(loc, loc + 2); ++loc; //Leap over the load(0) instruction
                ...
                case Operators.COR:
                    ...
                    vm.UncondJump(loc, loc + 2); ++loc;
                    //2. b. Evaluate to true (without evaluating right hand side)
                    vm.IntLoad(loc++, 1);
                    break;
                default:
                    throw new IVirtualMachine.InternalError("There's an invalid operator in ASTBoolOpr. Operator: " + Operator.ToString());
            }
            return loc;
        }
    }
