...
namespace Compiler
{
    ...
    public class Symbol
    {
        ...
        public Action<Treenode, Treenode> Callback { get; set; }

        public Symbol(Terminals terminal, Action<Treenode, Treenode> callback)
        {
            this.Terminal = terminal;
            this.NotTerminal = null;
            this.Callback = callback;
        }
        public Symbol(NotTerminals notTerminal, Action<Treenode, Treenode> callback)
        {
            this.Terminal = null;
