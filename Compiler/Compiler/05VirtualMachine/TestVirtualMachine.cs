...
namespace Compiler
{
    ...
    public static class TestVirtualMachine
    {
        private const int CODE_SIZE = 1000;
        private const int STORE_SIZE = 1000;
        private static readonly IVirtualMachine vm = null;
